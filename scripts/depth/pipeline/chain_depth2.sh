...
DSE_GPUS=$G $TR --nproc_per_node=$NP --master_port=29631 scripts/train_sft.py --data data/train3r/phase1.jsonl --init checkpoints/depth/sft_a --skip-frac 0.5 --out checkpoints/depth/sft_a --epochs 1 --lr 9e-5 --accum 16 > $L/train_sft_a_resume.log 2>&1
